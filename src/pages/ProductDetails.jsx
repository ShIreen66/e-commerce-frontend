...
const ProductDetails = () => {
    ...
    const UpdateProductHandler = (updatedProduct) => {
        ...
        setTimeout(() => {
            navigate(`/`); // You can change this to `/products` or `/product/${product.id}` as needed
        }, 1200);
    };
    const DeleteHandler = () => {
        ...
        <>
            ...
            <div className="w-full flex flex-col md:flex-row gap-8 items-start justify-center p-6 bg-gray-50 min-h-[80vh]">
                <div className="w-full max-w-lg bg-white shadow-xl rounded-xl p-8 border border-gray-100">
                    ...
                    <button className="w-full  bg-yellow-400 hover:bg-yellow-500 text-white font-semibold py-3 rounded-lg shadow transition cursor-pointer text-xl">
                        Add to cart
                    </button>
                </div>
