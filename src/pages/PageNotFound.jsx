  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] bg-gradient-to-br from-indigo-100 via-white to-blue-100 px-4">
      <div className="bg-white/95 rounded-3xl shadow-2xl border border-indigo-100 p-12 flex flex-col items-center relative overflow-hidden">
        ...
        <h1 className="text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-600 mb-4 drop-shadow-lg z-10">
          404
        </h1>
        ...
        <a
          href="/"
          className="bg-gradient-to-r from-indigo-500 to-blue-500 text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:from-blue-500 hover:to-indigo-500 transition text-lg z-10"
        >
          Go Back
        </a>
      </div>
