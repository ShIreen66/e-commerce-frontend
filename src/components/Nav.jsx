...
import { FaHome, FaUserCog, FaShoppingCart, FaSignInAlt, FaInfoCircle, FaPlus } from "react-icons/fa";
...
const Nav = () => {
    ...
    if (!user) {
        return (
            <nav className="flex justify-center flex-wrap gap-4 mb-10 p-4 bg-white shadow-lg rounded-xl border border-gray-100">
    ...
    return (
        <nav className="flex justify-between items-center flex-wrap gap-4 mb-10 p-4 bg-white shadow-lg rounded-xl border border-gray-100">
            <div className="flex gap-4 items-center">
                ...
                {/* Create Product after Home, only for admin */}
                {user?.isAdmin && (
